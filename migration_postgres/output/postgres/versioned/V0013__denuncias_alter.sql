...
-- - intercepta_con varchar(200) (calle que intersecta, RN17.3)
-- - villa_poblacion varchar(100) (nombre de villa o población)
...
CREATE TABLE denuncias.cat_lugar_recepcion_denuncia(
 id_lugar_recepcion_denuncia int generated by default as generated by default as identity NOT NULL,
...
CREATE TABLE denuncias.cat_detalle_lugar_recepcion_denuncia(
 id_detalle_lugar_recepcion_denuncia int generated by default as generated by default as identity NOT NULL,
...
ALTER TABLE ubicacion.lugar_base
 ADD intercepta_con varchar(200) NULL,
 villa_poblacion varchar(100) NULL,
...
CREATE TABLE organizacion.cat_tipo_organismo(
 id_tipo_organismo int generated by default as generated by default as identity NOT NULL,
...
CREATE TABLE organizacion.cat_nivel_organismo(
 id_nivel_organismo int generated by default as generated by default as identity NOT NULL,
 codigo varchar(20) NOT NULL,
 descripcion varchar(100) NOT NULL,
...
-- Tabla: organizacion.cat_tipo_organismo
-- -----------------------------------------------------------------------------
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Catálogo de tipos de organismo externo. Clasifica funcionalmente los organismos: POLICIA, FISCALIA, TRIBUNAL, LABORATORIO, AGENCIA_GOB, INT_INTERNACIONAL, OTRO. Reemplaza la columna string libre tipo_organismo varchar(30) que existía previamente en cat_organismo_externo.', @level0type=N'SCHEMA',@level0name=N'organizacion', @level1type=N'TABLE',@level1name=N'cat_tipo_organismo';
...
-- Tabla: organizacion.cat_nivel_organismo
-- -----------------------------------------------------------------------------
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Catálogo de niveles de alcance territorial de los organismos: NACIONAL, REGIONAL, INTERNACIONAL. Reemplaza la columna string libre nivel varchar(20) que existía previamente en cat_organismo_externo.', @level0type=N'SCHEMA',@level0name=N'organizacion', @level1type=N'TABLE',@level1name=N'cat_nivel_organismo';
...
-- -----------------------------------------------------------------------------
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'FK a organizacion.cat_tipo_organismo. Clasificación funcional del organismo. Reemplaza la columna string libre tipo_organismo varchar(30) anterior. Permite filtrar por tipo según contexto de uso (ej: filtrar fiscalías para el dropdown de denuncia.id_organismo_fiscalia).', @level0type=N'SCHEMA',@level0name=N'organizacion', @level1type=N'TABLE',@level1name=N'cat_organismo_externo', @level2type=N'COLUMN',@level2name=N'id_tipo_organismo';
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'FK a organizacion.cat_nivel_organismo. Alcance territorial del organismo. Reemplaza la columna string libre nivel varchar(20) anterior.', @level0type=N'SCHEMA',@level0name=N'organizacion', @level1type=N'TABLE',@level1name=N'cat_organismo_externo', @level2type=N'COLUMN',@level2name=N'id_nivel_organismo';
