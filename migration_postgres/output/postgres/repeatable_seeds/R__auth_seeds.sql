-- =============================================================================
-- SIP â€” Repeatable Migration: R__auth_seeds.sql
-- =============================================================================
...
--
-- ALCANCE:
-- Carga el catÃ¡logo RBAC institucional del Sistema Integrado Policial
-- (PDI) segÃºn el documento "Modelo operacional SIP - Perfiles y Roles".
--
-- CONTENIDO:
-- - 7 perfiles institucionales (VIS, CIP, POL, PER, ALA, CAD, SOP)
-- - 15 roles funcionales
-- - 5 niveles de seguridad (1=PÃºblica .. 5=Secreta propia)
-- - 16 combinaciones perfil-rol-nivel con sus claim_codes para JWT
-- (POL-IN aparece dos veces: nivel 2 y 3, segÃºn experiencia)
-- - 34 permisos atÃ³micos: 14 operativas (O*), 12 documentales (D*),
-- 5 control y auditorÃ­a (C*), 3 mantenciÃ³n (M*)
-- - 229 asignaciones perfil_rol â†’ permiso segÃºn matriz de funciones
--
-- NOTA SOBRE LOS PERMISOS C* (control y auditorÃ­a):
-- El documento PDI tiene un C1 duplicado (aparece como C1 en dos filas:
-- "Ver bitÃ¡cora de actividades de caso" y "Ver logs generales"). Para
-- evitar el conflicto con el UNIQUE de codigo_funcion, se reasignÃ³ asÃ­
-- conservando la semÃ¡ntica original de C2/C3/C4 del documento:
-- C1 = Ver bitÃ¡cora de actividades de caso (sin cambios)
-- C2 = Ver historial de cambios (sin cambios)
-- C3 = Generar observaciÃ³n de mal ingreso (sin cambios)
-- C4 = Generar amonestaciÃ³n por mal ingreso (sin cambios)
-- C5 = Ver logs generales (era el segundo C1)
-- TODO: confirmar con PDI la numeraciÃ³n definitiva de C*.
--
-- ESTRUCTURA DEL ARCHIVO:
-- PASO 1 â€” CatÃ¡logos base: perfil, rol, nivel_seguridad, permiso
-- PASO 2 â€” perfil_rol (combinaciones perfil-rol-nivel con claim_code)
-- PASO 3 â€” perfil_rol_permiso (matriz de funciones por claim)
--
-- IDEMPOTENCIA:
...
-- duplicados ni rompe â€” actualiza nombres/descripciones si cambiaron.
-- =============================================================================
SET ANSI_NULLS ON;
...
USING (VALUES
 (N'Visualizador', 'VIS', N'Personal de apoyo o administrativo que no desarrolla investigaciones ni ingresa datos al sistema, sino que sÃ³lo consume datos de nivel bÃ¡sico.'),
 ...
 (N'Policial', 'POL', N'Funcionarios policiales que desarrollan investigaciones e ingresan informaciÃ³n al sistema.'),
 (N'Perito', 'PER', N'Personal pericial que elabora informes y alimenta casos con informaciÃ³n de carÃ¡cter pericial.'),
 (N'Analista', 'ALA', N'Funcionarios que se desempeÃ±an en Oficinas de AnÃ¡lisis Criminal y elaboran reportes analÃ­ticos.'),
 (N'Control y auditorÃ­a', 'CAD', N'Personal a cargo de control, auditorÃ­a, gobernanza de datos y asuntos internos.'),
 (N'Soporte', 'SOP', N'Personal tÃ©cnico de soporte, administraciÃ³n de base de datos y desarrollo de la plataforma.'),
...
USING (VALUES
 (1, N'Ver informaciÃ³n PÃºblica.'),
 (2, N'Ver informaciÃ³n PÃºblica. Crear informaciÃ³n PÃºblica.'),
 (3, N'Ver informaciÃ³n PÃºblica. Crear informaciÃ³n PÃºblica. Crear informaciÃ³n Reservada (con validaciÃ³n). Ver informaciÃ³n Reservada propia.'),
 (4, N'Ver informaciÃ³n PÃºblica. Crear informaciÃ³n PÃºblica. Crear informaciÃ³n Reservada (con validaciÃ³n). Ver informaciÃ³n Reservada.'),
 (5, N'Ver informaciÃ³n PÃºblica. Crear informaciÃ³n PÃºblica. Crear informaciÃ³n Reservada (con validaciÃ³n). Ver informaciÃ³n Reservada. Crear informaciÃ³n Secreta (con validaciÃ³n). Ver informaciÃ³n Secreta propia.')
...
USING (VALUES
 ...
 ('O13', N'Crear agrupaciÃ³n criminal', N'Operativas'),
 ('O14', N'Editar agrupaciÃ³n criminal', N'Operativas'),
 ('D1', N'Crear documento externo', N'Documentales'),
 ('D2', N'Crear documento policial', N'Documentales'),
 ('D3', N'Crear documento analÃ­tico', N'Documentales'),
 ...
 ('D9', N'Ver documentos analÃ­ticos', N'Documentales'),
 ('D10', N'Visar documentos analÃ­ticos', N'Documentales'),
 ('D11', N'Ver documentos periciales', N'Documentales'),
 ('D12', N'Visar documentos periciales', N'Documentales'),
 ('C1', N'Ver bitÃ¡cora de actividades de caso', N'Control y auditorÃ­a'),
 ('C2', N'Ver historial de cambios', N'Control y auditorÃ­a'),
 ('C3', N'Generar observaciÃ³n de mal ingreso', N'Control y auditorÃ­a'),
 ('C4', N'Generar amonestaciÃ³n por mal ingreso', N'Control y auditorÃ­a'),
 ('C5', N'Ver logs generales', N'Control y auditorÃ­a'),
 ('M1', N'Gestionar perfiles y roles de usuarios', N'MantenciÃ³n'),
 ('M2', N'Gestionar la base de datos', N'MantenciÃ³n'),
 ('M3', N'Efectuar cambios a nivel de desarrollo', N'MantenciÃ³n')
...
-- PASO 2 â€” perfil_rol (combinaciones perfil-rol-nivel con claim_code)
-- =============================================================================
-- Resuelve los IDs por sigla/nivel desde los catÃ¡logos cargados arriba.
...
-- =============================================================================
-- PASO 3 â€” perfil_rol_permiso (matriz de funciones)
-- =============================================================================
...
-- Total de filas en la matriz: 229 asignaciones segÃºn el documento PDI.
