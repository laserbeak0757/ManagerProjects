/* =============================================================================
   V0026 — Parte aditiva del patron de auditoria de 6 columnas
...
IF COL_LENGTH(N'analitica.aplicacion_reporte', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[aplicacion_reporte] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.aplicacion_reporte', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[aplicacion_reporte] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.cat_tipo_reporte', N'fecha_creacion') IS NULL
    ALTER TABLE [analitica].[cat_tipo_reporte] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.cat_tipo_reporte', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[cat_tipo_reporte] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.cat_tipo_reporte', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[cat_tipo_reporte] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.configuracion_reporte_periodico', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[configuracion_reporte_periodico] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.configuracion_reporte_periodico', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[configuracion_reporte_periodico] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.foco_caso', N'fecha_creacion') IS NULL
    ALTER TABLE [analitica].[foco_caso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.foco_caso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[foco_caso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.foco_caso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[foco_caso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.foco_investigativo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[foco_investigativo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.foco_investigativo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[foco_investigativo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.matriz_analisis', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[matriz_analisis] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.reporte_analitico', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[reporte_analitico] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.reporte_analitico_caso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[reporte_analitico_caso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'analitica.reporte_analitico_caso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [analitica].[reporte_analitico_caso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'analitica.vinculo_entidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [analitica].[vinculo_entidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'archivos.archivo', N'fecha_creacion') IS NULL
    ALTER TABLE [archivos].[archivo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.archivo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [archivos].[archivo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'archivos.archivo_vinculo', N'fecha_creacion') IS NULL
    ALTER TABLE [archivos].[archivo_vinculo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.archivo_vinculo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [archivos].[archivo_vinculo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.archivo_vinculo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [archivos].[archivo_vinculo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'archivos.cat_nivel_confidencialidad', N'fecha_creacion') IS NULL
    ALTER TABLE [archivos].[cat_nivel_confidencialidad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.cat_nivel_confidencialidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [archivos].[cat_nivel_confidencialidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.cat_nivel_confidencialidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [archivos].[cat_nivel_confidencialidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'archivos.cat_tipo_archivo', N'fecha_creacion') IS NULL
    ALTER TABLE [archivos].[cat_tipo_archivo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.cat_tipo_archivo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [archivos].[cat_tipo_archivo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'archivos.cat_tipo_archivo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [archivos].[cat_tipo_archivo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'auth.nivel_seguridad', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[nivel_seguridad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.nivel_seguridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[nivel_seguridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.nivel_seguridad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[nivel_seguridad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.parametro', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[parametro] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.parametro', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[parametro] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.parametro', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[parametro] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.perfil', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[perfil] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[perfil] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[perfil] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.perfil_rol', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[perfil_rol] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil_rol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[perfil_rol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil_rol', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[perfil_rol] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.perfil_rol_permiso', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[perfil_rol_permiso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil_rol_permiso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[perfil_rol_permiso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.perfil_rol_permiso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[perfil_rol_permiso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.permiso', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[permiso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.permiso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[permiso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.permiso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[permiso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.refresh_token', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[refresh_token] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.refresh_token', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[refresh_token] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.rol', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[rol] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.rol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[rol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.rol', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[rol] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.usuario', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[usuario] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.usuario', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[usuario] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'auth.usuario_perfil', N'fecha_creacion') IS NULL
    ALTER TABLE [auth].[usuario_perfil] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.usuario_perfil', N'fecha_actualizacion') IS NULL
    ALTER TABLE [auth].[usuario_perfil] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'auth.usuario_perfil', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [auth].[usuario_perfil] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'casos.cat_tipo_rol_persona', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_tipo_rol_persona] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_tipo_rol_persona', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_tipo_rol_persona] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_tipo_rol_persona', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_tipo_rol_persona] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.agrupacion_causa', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[agrupacion_causa] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.agrupacion_causa', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[agrupacion_causa] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.agrupacion_causa', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[agrupacion_causa] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.agrupacion_causa_caso', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[agrupacion_causa_caso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.agrupacion_causa_caso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[agrupacion_causa_caso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.agrupacion_causa_caso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[agrupacion_causa_caso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.asignacion_funcionario', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[asignacion_funcionario] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.asignacion_funcionario', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[asignacion_funcionario] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.asignacion_funcionario', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[asignacion_funcionario] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.carpeta', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[carpeta] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.carpeta_colaborador', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[carpeta_colaborador] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.carpeta_colaborador', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[carpeta_colaborador] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.carpeta_colaborador', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[carpeta_colaborador] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.caso_historial_estado', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[caso_historial_estado] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.caso_historial_estado', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[caso_historial_estado] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.caso_historial_estado', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[caso_historial_estado] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.caso_persona_rol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[caso_persona_rol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.caso_referencia_judicial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[caso_referencia_judicial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.caso_referencia_judicial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[caso_referencia_judicial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_complejidad', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_complejidad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_complejidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_complejidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_complejidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_complejidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_estado_caso', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_estado_caso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_estado_caso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_estado_caso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_estado_caso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_estado_caso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_grupo_operativo', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_grupo_operativo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_grupo_operativo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_grupo_operativo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_grupo_operativo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_grupo_operativo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_nivel_seguridad', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_nivel_seguridad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_nivel_seguridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_nivel_seguridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_nivel_seguridad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_nivel_seguridad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_origen_caso', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_origen_caso] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_origen_caso', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_origen_caso] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_origen_caso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_origen_caso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.cat_prioridad', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[cat_prioridad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_prioridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[cat_prioridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.cat_prioridad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[cat_prioridad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'casos.matriz_riesgo', N'fecha_creacion') IS NULL
    ALTER TABLE [casos].[matriz_riesgo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.matriz_riesgo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [casos].[matriz_riesgo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'casos.matriz_riesgo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [casos].[matriz_riesgo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'catalogo_bienes.clase', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[clase] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.clase', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[clase] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'catalogo_bienes.codigo_reemplazado', N'fecha_creacion') IS NULL
    ALTER TABLE [catalogo_bienes].[codigo_reemplazado] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.codigo_reemplazado', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[codigo_reemplazado] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.codigo_reemplazado', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[codigo_reemplazado] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'catalogo_bienes.familia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[familia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.familia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[familia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'catalogo_bienes.producto', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[producto] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.producto', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[producto] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'catalogo_bienes.segmento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[segmento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.segmento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[segmento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'catalogo_bienes.version_catalogo', N'fecha_creacion') IS NULL
    ALTER TABLE [catalogo_bienes].[version_catalogo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.version_catalogo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [catalogo_bienes].[version_catalogo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'catalogo_bienes.version_catalogo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [catalogo_bienes].[version_catalogo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'configuracion.cat_dominio', N'fecha_creacion') IS NULL
    ALTER TABLE [configuracion].[cat_dominio] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'configuracion.cat_dominio', N'fecha_actualizacion') IS NULL
    ALTER TABLE [configuracion].[cat_dominio] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'configuracion.cat_dominio', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [configuracion].[cat_dominio] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'configuracion.cat_elemento_dominio', N'fecha_creacion') IS NULL
    ALTER TABLE [configuracion].[cat_elemento_dominio] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'configuracion.cat_elemento_dominio', N'fecha_actualizacion') IS NULL
    ALTER TABLE [configuracion].[cat_elemento_dominio] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'configuracion.cat_elemento_dominio', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [configuracion].[cat_elemento_dominio] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'configuracion.cat_programa_seguridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [configuracion].[cat_programa_seguridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'configuracion.cat_programa_seguridad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [configuracion].[cat_programa_seguridad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'cooperacion_int.cat_cooperacion_internacional', N'fecha_creacion') IS NULL
    ALTER TABLE [cooperacion_int].[cat_cooperacion_internacional] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'cooperacion_int.cat_cooperacion_internacional', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[cat_cooperacion_internacional] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'cooperacion_int.cat_cooperacion_internacional', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [cooperacion_int].[cat_cooperacion_internacional] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.cat_elemento_cooperacion_internacional', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[cat_elemento_cooperacion_internacional] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.entidad_interpol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[entidad_interpol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.estado_solicitud_interpol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[estado_solicitud_interpol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.motivo_solicitud_interpol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[motivo_solicitud_interpol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.solicitud_interpol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[solicitud_interpol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'cooperacion_int.tipo_consulta_solicitud_interpol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [cooperacion_int].[tipo_consulta_solicitud_interpol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'denuncias.denuncia_hecho', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[denuncia_hecho] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.denuncia_hecho', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[denuncia_hecho] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.denuncia_hecho', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[denuncia_hecho] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.cat_estado_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[cat_estado_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_estado_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[cat_estado_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_estado_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[cat_estado_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.cat_tipo_relato', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_relato] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_tipo_relato', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_relato] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_tipo_relato', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_relato] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.cat_estado_envio_fiscalia', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[cat_estado_envio_fiscalia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_estado_envio_fiscalia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[cat_estado_envio_fiscalia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_estado_envio_fiscalia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[cat_estado_envio_fiscalia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.cat_tipo_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_tipo_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.cat_tipo_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[cat_tipo_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.denuncia_persona_rol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[denuncia_persona_rol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.log_guardar_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [denuncias].[log_guardar_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.log_guardar_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[log_guardar_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.log_guardar_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[log_guardar_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.pauta_vif', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[pauta_vif] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'denuncias.procedimiento_persona', N'fecha_actualizacion') IS NULL
    ALTER TABLE [denuncias].[procedimiento_persona] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'denuncias.procedimiento_persona', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [denuncias].[procedimiento_persona] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.actividad_investigativa', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[actividad_investigativa] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_especialidad_pericial', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_especialidad_pericial] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_especialidad_pericial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_especialidad_pericial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_especialidad_pericial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_especialidad_pericial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_estado_diligencia', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_estado_diligencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_estado_diligencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_estado_diligencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_estado_diligencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_estado_diligencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_estado_instruccion', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_estado_instruccion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_estado_instruccion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_estado_instruccion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_estado_instruccion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_estado_instruccion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_fuente_observacion_externa', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_fuente_observacion_externa] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_fuente_observacion_externa', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_fuente_observacion_externa] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_fuente_observacion_externa', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_fuente_observacion_externa] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_detencion', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_detencion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_detencion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_detencion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_detencion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_detencion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_diligencia', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_diligencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_diligencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_diligencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_diligencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_diligencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_informe', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_informe] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_informe', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_informe] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_informe', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_informe] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_instruccion', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_instruccion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_instruccion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_instruccion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_instruccion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_instruccion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_notificacion_externa', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_notificacion_externa] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_notificacion_externa', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_notificacion_externa] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_notificacion_externa', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_notificacion_externa] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.cat_tipo_peritaje', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_peritaje] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_peritaje', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_peritaje] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.cat_tipo_peritaje', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[cat_tipo_peritaje] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.detencion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[detencion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.detencion_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[detencion_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.diligencia_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[diligencia_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.informe_policial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[informe_policial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.notificacion_externa', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[notificacion_externa] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.notificacion_externa', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[notificacion_externa] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.solicitud_concurrencia_pericial', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[solicitud_concurrencia_pericial] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.solicitud_concurrencia_pericial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[solicitud_concurrencia_pericial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'diligencias.solicitud_concurrencia_perito', N'fecha_creacion') IS NULL
    ALTER TABLE [diligencias].[solicitud_concurrencia_perito] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.solicitud_concurrencia_perito', N'fecha_actualizacion') IS NULL
    ALTER TABLE [diligencias].[solicitud_concurrencia_perito] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'diligencias.solicitud_concurrencia_perito', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [diligencias].[solicitud_concurrencia_perito] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'encargos.encargo', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[encargo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[encargo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[encargo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.encargo_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[encargo_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[encargo_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[encargo_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.encargo_orden_judicial', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[encargo_orden_judicial] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_orden_judicial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[encargo_orden_judicial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_orden_judicial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[encargo_orden_judicial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.encargo_persona_diligencia', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[encargo_persona_diligencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_persona_diligencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[encargo_persona_diligencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.encargo_persona_diligencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[encargo_persona_diligencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.orden_judicial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[orden_judicial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.orden_judicial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[orden_judicial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.tarea_encargo', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[tarea_encargo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tarea_encargo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[tarea_encargo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tarea_encargo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[tarea_encargo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.tipo_encargo', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[tipo_encargo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tipo_encargo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[tipo_encargo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tipo_encargo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[tipo_encargo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'encargos.tipo_orden_judicial', N'fecha_creacion') IS NULL
    ALTER TABLE [encargos].[tipo_orden_judicial] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tipo_orden_judicial', N'fecha_actualizacion') IS NULL
    ALTER TABLE [encargos].[tipo_orden_judicial] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'encargos.tipo_orden_judicial', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [encargos].[tipo_orden_judicial] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'evidencias.arma', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[arma] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cadena_custodia', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cadena_custodia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cadena_custodia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cadena_custodia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cadena_custodia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cadena_custodia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_catalogo_armas', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_catalogo_armas] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_catalogo_armas', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_catalogo_armas] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_clasificacion_arma', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_clasificacion_arma] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_clasificacion_arma', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_clasificacion_arma] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_clasificacion_arma', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_clasificacion_arma] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_droga', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_droga] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_droga', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_droga] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_estado_especie', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_estado_especie] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_estado_especie', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_estado_especie] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_estado_especie', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_estado_especie] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_institucion', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_institucion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_institucion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_institucion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_institucion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_institucion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_proposito_transferencia', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_proposito_transferencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_proposito_transferencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_proposito_transferencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_proposito_transferencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_proposito_transferencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_tipo_custodia', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_custodia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_tipo_custodia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_custodia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_tipo_custodia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_custodia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.cat_tipo_extension_especie', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_extension_especie] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_tipo_extension_especie', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_extension_especie] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.cat_tipo_extension_especie', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[cat_tipo_extension_especie] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_arma', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_arma] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_arma', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_arma] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_arma', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_arma] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_droga', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_droga] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_droga', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_droga] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_droga', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_droga] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_electronico', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_electronico] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_electronico', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_electronico] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_electronico', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_electronico] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_historial_estado', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_historial_estado] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_historial_estado', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_historial_estado] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_historial_estado', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_historial_estado] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_otras', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_otras] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_otras', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_otras] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_otras', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_otras] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_retencion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_retencion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_retencion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_retencion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_sello', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_sello] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_sello', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_sello] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_sello', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_sello] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.especie_vehiculo', N'fecha_creacion') IS NULL
    ALTER TABLE [evidencias].[especie_vehiculo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_vehiculo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[especie_vehiculo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.especie_vehiculo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[especie_vehiculo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.evidencia_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[evidencia_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'evidencias.incautacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [evidencias].[incautacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'evidencias.incautacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [evidencias].[incautacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'investigacion.cat_lugar_general_hecho', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_lugar_general_hecho] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_lugar_general_hecho', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_lugar_general_hecho] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_lugar_general_hecho', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_lugar_general_hecho] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_detalle_lugar_general_hecho', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_detalle_lugar_general_hecho] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_detalle_lugar_general_hecho', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_detalle_lugar_general_hecho] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_detalle_lugar_general_hecho', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_detalle_lugar_general_hecho] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_forma_contacto', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_forma_contacto] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_punto_acceso', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_punto_acceso] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_transporte_utilizado', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_transporte_utilizado] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.hecho_persona_rol', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[hecho_persona_rol] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.clasificacion_delito', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[clasificacion_delito] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.clasificacion_delito', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[clasificacion_delito] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.clasificacion_delito', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[clasificacion_delito] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_seccion_catalogo', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_seccion_catalogo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_seccion_catalogo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_seccion_catalogo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_seccion_catalogo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_seccion_catalogo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_familia_delito', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_familia_delito] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_familia_delito', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_familia_delito] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_familia_delito', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_familia_delito] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_delito', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_delito] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.hecho_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[hecho_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.hecho_fenomeno', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[hecho_fenomeno] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.hecho_fenomeno', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[hecho_fenomeno] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.fenomeno_delictual', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[fenomeno_delictual] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_circunstancia_modificatoria', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_circunstancia_modificatoria] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_circunstancia_modificatoria', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_circunstancia_modificatoria] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_circunstancia_modificatoria', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_circunstancia_modificatoria] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_grado_ejecucion', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_grado_ejecucion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_grado_ejecucion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_grado_ejecucion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_grado_ejecucion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_grado_ejecucion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_grado_participacion', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[cat_grado_participacion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_grado_participacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[cat_grado_participacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.cat_grado_participacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_grado_participacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.cat_movil', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[cat_movil] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.delito_circunstancia', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[delito_circunstancia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.delito_circunstancia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[delito_circunstancia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.delito_circunstancia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[delito_circunstancia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.delito_imputado_persona', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[delito_imputado_persona] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'investigacion.subtipo_delito_secuestro', N'fecha_creacion') IS NULL
    ALTER TABLE [investigacion].[subtipo_delito_secuestro] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.subtipo_delito_secuestro', N'fecha_actualizacion') IS NULL
    ALTER TABLE [investigacion].[subtipo_delito_secuestro] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'investigacion.subtipo_delito_secuestro', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [investigacion].[subtipo_delito_secuestro] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'migracion.cat_tipo_infraccion_migratoria', N'fecha_creacion') IS NULL
    ALTER TABLE [migracion].[cat_tipo_infraccion_migratoria] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'migracion.cat_tipo_infraccion_migratoria', N'fecha_actualizacion') IS NULL
    ALTER TABLE [migracion].[cat_tipo_infraccion_migratoria] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'migracion.cat_tipo_infraccion_migratoria', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [migracion].[cat_tipo_infraccion_migratoria] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'migracion.denuncia_administrativa_migratoria', N'fecha_actualizacion') IS NULL
    ALTER TABLE [migracion].[denuncia_administrativa_migratoria] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'migracion.denuncia_administrativa_migratoria', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [migracion].[denuncia_administrativa_migratoria] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.unidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[unidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_organismo_externo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_organismo_externo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_tipo_organismo', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_organismo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_organismo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_organismo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_organismo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_organismo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_cargo_funcion', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[cat_cargo_funcion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_cargo_funcion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[cat_cargo_funcion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_cargo_funcion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_cargo_funcion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_nivel_organismo', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[cat_nivel_organismo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_nivel_organismo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[cat_nivel_organismo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_nivel_organismo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_nivel_organismo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_tipo_relacion_unidad', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_relacion_unidad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_relacion_unidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_relacion_unidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_relacion_unidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_relacion_unidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.cat_tipo_unidad', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_unidad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_unidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_unidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.cat_tipo_unidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[cat_tipo_unidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.ofan_fiscalia', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[ofan_fiscalia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.ofan_fiscalia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[ofan_fiscalia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.ofan_fiscalia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[ofan_fiscalia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'organizacion.relacion_unidad', N'fecha_creacion') IS NULL
    ALTER TABLE [organizacion].[relacion_unidad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.relacion_unidad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [organizacion].[relacion_unidad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'organizacion.relacion_unidad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [organizacion].[relacion_unidad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'personas.nombre', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[nombre] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.identificacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[identificacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.alias', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[alias] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.anotacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[anotacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_actividad_economica', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_actividad_economica] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_actividad_economica', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_actividad_economica] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_actividad_economica', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_actividad_economica] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_color_cabello', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_color_cabello] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_cabello', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_color_cabello] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_cabello', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_color_cabello] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_color_ojos', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_color_ojos] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_ojos', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_color_ojos] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_ojos', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_color_ojos] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_color_piel', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_color_piel] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_piel', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_color_piel] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_color_piel', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_color_piel] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_complexion', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_complexion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_complexion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_complexion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_complexion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_complexion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_forma_rostro', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_forma_rostro] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_forma_rostro', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_forma_rostro] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_forma_rostro', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_forma_rostro] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_genero', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_genero] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_genero', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_genero] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_genero', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_genero] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_nivel_escolaridad', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_nivel_escolaridad] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_nivel_escolaridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_nivel_escolaridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_nivel_escolaridad', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_nivel_escolaridad] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_ocupacion', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_ocupacion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_ocupacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_ocupacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_ocupacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_ocupacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_sexo', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_sexo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_sexo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_sexo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_sexo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_sexo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_anotacion', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_anotacion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_anotacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_anotacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_anotacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_anotacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_biometrico', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_biometrico] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_biometrico', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_biometrico] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_biometrico', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_biometrico] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_cabello', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_cabello] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_cabello', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_cabello] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_cabello', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_cabello] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_estado_civil', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_estado_civil] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_estado_civil', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_estado_civil] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_estado_civil', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_estado_civil] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_fotografia', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_fotografia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_fotografia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_fotografia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_fotografia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_fotografia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_nombre', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_nombre] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_nombre', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_nombre] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_nombre', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_nombre] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_persona', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_persona', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_persona', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_persona_juridica', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona_juridica] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_persona_juridica', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona_juridica] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_persona_juridica', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_persona_juridica] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_rasgo_distintivo', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_rasgo_distintivo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_rasgo_distintivo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_rasgo_distintivo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_rasgo_distintivo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_rasgo_distintivo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_red_social', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_red_social] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_red_social', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_red_social] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_red_social', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_red_social] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_relacion', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_relacion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_relacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_relacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_relacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_relacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_representacion', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_representacion] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_representacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_representacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_representacion', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_representacion] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_tipo_telefono', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_telefono] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_telefono', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_tipo_telefono] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_tipo_telefono', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_tipo_telefono] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.cat_ubicacion_corporal', N'fecha_creacion') IS NULL
    ALTER TABLE [personas].[cat_ubicacion_corporal] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_ubicacion_corporal', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[cat_ubicacion_corporal] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'personas.cat_ubicacion_corporal', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [personas].[cat_ubicacion_corporal] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.contacto_otro', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[contacto_otro] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.correo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[correo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.descripcion_fisica', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[descripcion_fisica] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.empleo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[empleo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.escolaridad', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[escolaridad] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.estado_civil', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[estado_civil] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.fotografia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[fotografia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.persona_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[persona_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.rasgo_distintivo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[rasgo_distintivo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.red_social', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[red_social] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.referencia_biometrica', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[referencia_biometrica] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.relacion', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[relacion] ADD [fecha_actualizacion] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'personas.telefono', N'fecha_actualizacion') IS NULL
    ALTER TABLE [personas].[telefono] ADD [fecha_actualizacion] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'tareas.bandeja', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[bandeja] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.bandeja', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[bandeja] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.bandeja', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[bandeja] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.comentario_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[comentario_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.comentario_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[comentario_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.comentario_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[comentario_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.comentario_documento_nodo', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[comentario_documento_nodo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.comentario_documento_nodo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[comentario_documento_nodo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.comentario_documento_nodo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[comentario_documento_nodo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.documento_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[documento_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.documento_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[documento_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.documento_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[documento_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.estado_tarea', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[estado_tarea] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.estado_tarea', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[estado_tarea] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.estado_tarea', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[estado_tarea] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.evaluacion_comentario', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[evaluacion_comentario] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.evaluacion_comentario', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[evaluacion_comentario] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.evaluacion_comentario', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[evaluacion_comentario] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.nodo', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[nodo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.nodo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[nodo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.nodo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[nodo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tarea', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tarea] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tarea] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tarea] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tarea_archivo_adjunto', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tarea_archivo_adjunto] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_archivo_adjunto', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tarea_archivo_adjunto] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_archivo_adjunto', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tarea_archivo_adjunto] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tarea_denuncia', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tarea_denuncia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_denuncia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tarea_denuncia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_denuncia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tarea_denuncia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tarea_diligencia', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tarea_diligencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_diligencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tarea_diligencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_diligencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tarea_diligencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tarea_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tarea_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tarea_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tarea_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tarea_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tipo_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tipo_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tipo_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tipo_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tipo_estado_tarea', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tipo_estado_tarea] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_estado_tarea', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tipo_estado_tarea] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_estado_tarea', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tipo_estado_tarea] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tipo_tarea', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tipo_tarea] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_tarea', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tipo_tarea] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_tarea', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tipo_tarea] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.tipo_tarea_tipo_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[tipo_tarea_tipo_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_tarea_tipo_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[tipo_tarea_tipo_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.tipo_tarea_tipo_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[tipo_tarea_tipo_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'tareas.version_documento', N'fecha_creacion') IS NULL
    ALTER TABLE [tareas].[version_documento] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.version_documento', N'fecha_actualizacion') IS NULL
    ALTER TABLE [tareas].[version_documento] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'tareas.version_documento', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [tareas].[version_documento] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'ubicacion.pais', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[pais] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.pais', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[pais] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.pais', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[pais] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.lugar_base', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[lugar_base] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.cat_rol_lugar', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[cat_rol_lugar] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_rol_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[cat_rol_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_rol_lugar', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[cat_rol_lugar] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.cat_tipo_calle', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_calle] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_calle', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_calle] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_calle', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_calle] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.cat_tipo_lugar', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_lugar] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_lugar', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_lugar] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_lugar', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_lugar] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.cat_tipo_residencia', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_residencia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_residencia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_residencia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_residencia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_residencia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.cat_tipo_subdivision', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_subdivision] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.cat_tipo_subdivision', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[cat_tipo_subdivision] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.comuna', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[comuna] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.comuna', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[comuna] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.comuna', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[comuna] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.provincia', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[provincia] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.provincia', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[provincia] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.provincia', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[provincia] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'ubicacion.region', N'fecha_creacion') IS NULL
    ALTER TABLE [ubicacion].[region] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.region', N'fecha_actualizacion') IS NULL
    ALTER TABLE [ubicacion].[region] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'ubicacion.region', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [ubicacion].[region] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
GO
...
IF COL_LENGTH(N'vehiculos.cat_color', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_color] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_color', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_color] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_color', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_color] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.cat_marca', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_marca] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_marca', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_marca] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_marca', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_marca] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.cat_modelo', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_modelo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_modelo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_modelo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_modelo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_modelo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.cat_tipo', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_tipo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_tipo', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.cat_tipo_relacion_persona', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo_relacion_persona] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_tipo_relacion_persona', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo_relacion_persona] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_tipo_relacion_persona', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_tipo_relacion_persona] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.cat_version', N'fecha_creacion') IS NULL
    ALTER TABLE [vehiculos].[cat_version] ADD [fecha_creacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_version', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[cat_version] ADD [fecha_actualizacion] DATETIME2(7) NULL;
IF COL_LENGTH(N'vehiculos.cat_version', N'fecha_eliminacion_logica') IS NULL
    ALTER TABLE [vehiculos].[cat_version] ADD [fecha_eliminacion_logica] DATETIME2(7) NULL;
...
IF COL_LENGTH(N'vehiculos.persona_vehiculo', N'fecha_actualizacion') IS NULL
    ALTER TABLE [vehiculos].[persona_vehiculo] ADD [fecha_actualizacion] DATETIME2(7) NULL;
