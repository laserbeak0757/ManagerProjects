/* =============================================================================
   V0033 — Desacople funcionario<->persona (secuencia) + id_funcionario nullable
   PDI Chile — SIP. SQL Server. Flyway.   Sigue a V0032. Requiere V0001..V0032.
...
DECLARE @sqlSeq NVARCHAR(200) =
    N'ALTER SEQUENCE organizacion.seq_funcionario RESTART WITH ' + CAST(@next AS NVARCHAR(20)) + N';';
...
/* =====================  PARTE B — auth.usuario.id_funcionario nullable  ===== */
