...
ALTER TABLE denuncias.denuncia
ALTER COLUMN indicador_vif BIT NOT NULL;
...
ALTER TABLE denuncias.denuncia
ALTER COLUMN dominio_propiedad BIT NOT NULL;
...
ALTER TABLE denuncias.denuncia
ALTER COLUMN es_flagrancia BIT NOT NULL;

ALTER TABLE denuncias.denuncia
DROP CONSTRAINT ck_denuncia_puede_reconocer_imputado;

ALTER TABLE denuncias.denuncia
ALTER COLUMN puede_reconocer_imputado BIT NOT NULL;

ALTER TABLE denuncias.denuncia
DROP CONSTRAINT ck_denuncia_teme_por_seguridad;

ALTER TABLE denuncias.denuncia
ALTER COLUMN teme_por_seguridad BIT NOT NULL;
...
ALTER TABLE investigacion.delito_imputado
ALTER COLUMN folio NVARCHAR(30) NULL;
...
ALTER TABLE investigacion.delito_imputado
ALTER COLUMN contexto_vif BIT NOT NULL;
...
ALTER TABLE investigacion.delito_imputado
ALTER COLUMN es_delito_principal BIT NOT NULL;
...
ALTER TABLE organizacion.unidad
ALTER COLUMN es_lacrim BIT NOT NULL;
...
ALTER TABLE ubicacion.lugar_base
ALTER COLUMN direccion_exacta BIT NOT NULL;
