...
USING (VALUES
    ...
    (2, N'DENYVIC', N'Denunciante y víctima', 0, 0, 0, 0, 0, 0, 0),
    (3, N'VICTIMA', N'Víctima', 0, 0, 0, 0, 0, 0, 0),
    (4, N'TESTIGO', N'Testigo', 0, 0, 0, 0, 0, 0, 0),
    (5, N'IMPUTADO', N'Imputado', 0, 0, 0, 0, 0, 0, 0),
    (6, N'VICTIMA_NNA', N'Víctima Niño(a) y Adolescente', 0, 0, 0, 0, 0, 0, 0),
    (7, N'ACOMPANANTE_NNA', N'Acompañante', 0, 0, 0, 0, 0, 0, 0),
    (8, N'AGRESOR_NNA', N'Agresor (identificado espontáneamente)', 0, 0, 0, 0, 0, 0, 0),
